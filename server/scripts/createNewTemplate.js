...
const newTemplate = {
  ...
  description: "A clean, modern resume template with professional styling and excellent ATS compatibility. Features a two-column layout with emphasis on readability and visual hierarchy.",
  category: "Professional",
  tags: ["modern", "professional", "ats-friendly", "clean", "two-column"],
...
@media print {
  ...
  features: ["ATS-friendly", "Two-column layout", "Modern design", "Print optimized", "Mobile responsive"],
  previewImages: [],
  downloadCount: 0,
  price: 0,
  mobile: true,
