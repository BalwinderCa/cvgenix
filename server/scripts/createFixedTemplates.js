...
// Fixed Executive Resume - Dark text on white background
const executiveResume = {
  ...
  objects: [
    ...
    // Contact Information in header (white text on dark bg)
    ...
    { type: "text", left: 50, top: 150, width: 700, height: 30, fill: "#1a1a1a", text: "EXECUTIVE SUMMARY", fontSize: 16, fontWeight: "bold", fontFamily: "Arial", id: "summary_header" },
    { type: "text", left: 50, top: 180, width: 700, height: 60, fill: "#2c3e50", text: "Seasoned technology executive with 15+ years of experience leading engineering teams and driving digital transformation initiatives. Proven track record of scaling technology organizations and delivering innovative solutions.", fontSize: 12, fontFamily: "Arial", id: "summary_text" },
    
    // Core Competencies
    { type: "text", left: 50, top: 260, width: 700, height: 30, fill: "#1a1a1a", text: "CORE COMPETENCIES", fontSize: 16, fontWeight: "bold", fontFamily: "Arial", id: "competencies_header" },
    { type: "text", left: 50, top: 290, width: 700, height: 40, fill: "#2c3e50", text: "Strategic Planning • Technology Architecture • Team Leadership • Digital Transformation • Cloud Computing", fontSize: 12, fontFamily: "Arial", id: "competencies_text" },
    
    // Professional Experience
    { type: "text", left: 50, top: 350, width: 700, height: 30, fill: "#1a1a1a", text: "PROFESSIONAL EXPERIENCE", fontSize: 16, fontWeight: "bold", fontFamily: "Arial", id: "experience_header" },
    
    // Job 1
    { type: "text", left: 50, top: 390, width: 500, height: 20, fill: "#1a1a1a", text: "Chief Technology Officer", fontSize: 14, fontWeight: "bold", fontFamily: "Arial", id: "job1_title" },
    { type: "text", left: 560, top: 390, width: 150, height: 20, fill: "#7f8c8d", text: "2019 - Present", fontSize: 12, fontFamily: "Arial", id: "job1_dates" },
    { type: "text", left: 50, top: 410, width: 700, height: 20, fill: "#2c3e50", text: "TechCorp Inc. | San Francisco, CA", fontSize: 12, fontFamily: "Arial", id: "job1_company" },
    { type: "text", left: 50, top: 430, width: 700, height: 40, fill: "#2c3e50", text: "• Led digital transformation initiatives resulting in 40% operational efficiency improvement", fontSize: 11, fontFamily: "Arial", id: "job1_bullet1" },
    { type: "text", left: 50, top: 450, width: 700, height: 40, fill: "#2c3e50", text: "• Managed engineering team of 50+ developers across multiple product lines", fontSize: 11, fontFamily: "Arial", id: "job1_bullet2" },
    { type: "text", left: 50, top: 470, width: 700, height: 40, fill: "#2c3e50", text: "• Implemented cloud-first architecture reducing infrastructure costs by 60%", fontSize: 11, fontFamily: "Arial", id: "job1_bullet3" },
    
    // Job 2
    { type: "text", left: 50, top: 530, width: 500, height: 20, fill: "#1a1a1a", text: "VP of Engineering", fontSize: 14, fontWeight: "bold", fontFamily: "Arial", id: "job2_title" },
    { type: "text", left: 560, top: 530, width: 150, height: 20, fill: "#7f8c8d", text: "2016 - 2019", fontSize: 12, fontFamily: "Arial", id: "job2_dates" },
    { type: "text", left: 50, top: 550, width: 700, height: 20, fill: "#2c3e50", text: "StartupXYZ | San Francisco, CA", fontSize: 12, fontFamily: "Arial", id: "job2_company" },
    { type: "text", left: 50, top: 570, width: 700, height: 40, fill: "#2c3e50", text: "• Built engineering team from 5 to 30 developers", fontSize: 11, fontFamily: "Arial", id: "job2_bullet1" },
    { type: "text", left: 50, top: 590, width: 700, height: 40, fill: "#2c3e50", text: "• Architected scalable microservices platform serving 1M+ users", fontSize: 11, fontFamily: "Arial", id: "job2_bullet2" },
    { type: "text", left: 50, top: 610, width: 700, height: 40, fill: "#2c3e50", text: "• Led product development resulting in $50M revenue growth", fontSize: 11, fontFamily: "Arial", id: "job2_bullet3" },
    
    // Education
    { type: "text", left: 50, top: 670, width: 700, height: 30, fill: "#1a1a1a", text: "EDUCATION", fontSize: 16, fontWeight: "bold", fontFamily: "Arial", id: "education_header" },
    { type: "text", left: 50, top: 700, width: 500, height: 20, fill: "#1a1a1a", text: "Master of Science in Computer Science", fontSize: 14, fontWeight: "bold", fontFamily: "Arial", id: "degree" },
    { type: "text", left: 560, top: 700, width: 150, height: 20, fill: "#7f8c8d", text: "2010 - 2012", fontSize: 12, fontFamily: "Arial", id: "education_dates" },
    { type: "text", left: 50, top: 720, width: 700, height: 20, fill: "#2c3e50", text: "Stanford University | Stanford, CA", fontSize: 12, fontFamily: "Arial", id: "university" },
    { type: "text", left: 50, top: 740, width: 700, height: 20, fill: "#2c3e50", text: "GPA: 3.8/4.0 | Magna Cum Laude", fontSize: 12, fontFamily: "Arial", id: "gpa" },
    
    // Certifications
    { type: "text", left: 50, top: 780, width: 700, height: 30, fill: "#1a1a1a", text: "CERTIFICATIONS", fontSize: 16, fontWeight: "bold", fontFamily: "Arial", id: "certifications_header" },
    { type: "text", left: 50, top: 810, width: 700, height: 20, fill: "#2c3e50", text: "AWS Certified Solutions Architect - Professional (2023)", fontSize: 12, fontFamily: "Arial", id: "cert1" },
    { type: "text", left: 50, top: 830, width: 700, height: 20, fill: "#2c3e50", text: "Google Cloud Professional Cloud Architect (2022)", fontSize: 12, fontFamily: "Arial", id: "cert2" },
    { type: "text", left: 50, top: 850, width: 700, height: 20, fill: "#2c3e50", text: "Certified Kubernetes Administrator (CKA) (2021)", fontSize: 12, fontFamily: "Arial", id: "cert3" }
  ]
};

// Fixed Creative Designer Resume - Proper contrast
const creativeResume = {
  ...
  objects: [
    ...
    // Contact in header (white text on colored bg)
    ...
    // Skills in sidebar (dark text on light colored bg)
    ...
    // Main content area - DARK TEXT on white background
    ...
    { type: "text", left: 220, top: 210, width: 500, height: 40, fill: "#2c3e50", text: "• Led design team of 12 creatives across multiple client projects", fontSize: 11, fontFamily: "Arial", id: "job1_bullet1" },
    { type: "text", left: 220, top: 230, width: 500, height: 40, fill: "#2c3e50", text: "• Increased client satisfaction by 45% through improved design processes", fontSize: 11, fontFamily: "Arial", id: "job1_bullet2" },
    { type: "text", left: 220, top: 250, width: 500, height: 40, fill: "#2c3e50", text: "• Designed award-winning mobile app with 100K+ downloads", fontSize: 11, fontFamily: "Arial", id: "job1_bullet3" },
    ...
    { type: "text", left: 220, top: 350, width: 500, height: 40, fill: "#2c3e50", text: "• Designed user-centered interfaces for SaaS platform", fontSize: 11, fontFamily: "Arial", id: "job2_bullet1" },
    { type: "text", left: 220, top: 370, width: 500, height: 40, fill: "#2c3e50", text: "• Conducted user research with 200+ participants", fontSize: 11, fontFamily: "Arial", id: "job2_bullet2" },
    { type: "text", left: 220, top: 390, width: 500, height: 40, fill: "#2c3e50", text: "• Improved user engagement by 60% through UX optimization", fontSize: 11, fontFamily: "Arial", id: "job2_bullet3" },
    ...
    { type: "text", left: 220, top: 520, width: 500, height: 20, fill: "#2c3e50", text: "GPA: 3.9/4.0 | Summa Cum Laude", fontSize: 12, fontFamily: "Arial", id: "gpa" },
    ...
    { type: "text", left: 220, top: 590, width: 500, height: 20, fill: "#2c3e50", text: "• Awwwards Site of the Day (2023)", fontSize: 12, fontFamily: "Arial", id: "award1" },
    { type: "text", left: 220, top: 610, width: 500, height: 20, fill: "#2c3e50", text: "• Adobe Design Achievement Award (2022)", fontSize: 12, fontFamily: "Arial", id: "award2" },
    { type: "text", left: 220, top: 630, width: 500, height: 20, fill: "#2c3e50", text: "• Dribbble Designer of the Year (2021)", fontSize: 12, fontFamily: "Arial", id: "award3" }
  ]
};

// Fixed Medical Professional Resume - Proper contrast
const medicalResume = {
  version: "5.3.0",
  objects: [
...
const templates = [
  {
    ...
    description: "Complete professional resume for C-level executives with proper contrast and readability",
    category: "Executive",
    colorScheme: "dark",
  ...
  },
  {
    ...
    description: "Complete colorful resume template for creative professionals with proper text contrast",
    category: "Creative",
  ...
  },
  {
    ...
    description: "Complete formal resume template for healthcare professionals with readable text colors",
...
async function createFixedTemplates() {
  try {
    ...
    // Create fixed templates with proper contrast
    for (let i = 0; i < templates.length; i++) {
      ...
      const newTemplate = new Template({
        ...
        isPopular: true,
        isNewTemplate: true,
        tags: [template.category.toLowerCase(), template.colorScheme, template.layout, "complete", "fixed"],
        metadata: {
      ...
      console.log(`✅ Fixed template ${i + 1}/3 created: ${template.name} (${template.data.objects.length} objects)`);
    }

    console.log('🎉 All fixed templates created successfully!');
    ...
    console.error('❌ Error creating fixed templates:', error);
    process.exit(1);
  }
}

// Run the script
createFixedTemplates();
