...
const updateTemplatePositions = async () => {
  try {
    ...
    if (realEstateTemplate) {
      console.log('🔧 Updating Real Estate Agent Template positioning...')
      ...
      console.log('✅ Real Estate Agent Template updated')
    }
    ...
    if (mechanicalTemplate) {
      console.log('🔧 Updating Mechanical Engineer Template positioning...')
      ...
      console.log('✅ Mechanical Engineer Template updated')
    }
