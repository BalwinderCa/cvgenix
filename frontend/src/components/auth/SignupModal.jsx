      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 my-6 max-h-[90vh] overflow-y-auto"
          >
            {/* Close Button */}
            <button
              onClick={handleClose}
            ...
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-[#4a1f0f] mb-1.5">Create Account</h2>
              <p className="text-sm text-[#7a2c14]">Join thousands of job seekers</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="firstName" className="block text-sm font-semibold text-[#4a1f0f] mb-1.5">
                    First Name
                  </label>
                  <div className="relative">
                                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <FiUser className="h-5 w-5 text-[#7a2c14]" />
                  </div>
                  <input
                    {...register('firstName')}
                    type="text"
                ...
                <div>
                  <label htmlFor="lastName" className="block text-sm font-semibold text-[#4a1f0f] mb-1.5">
                    Last Name
                  </label>
                  <div className="relative">
                                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="confirmPassword" className="block text-sm font-semibold text-[#4a1f0f] mb-1.5">
                    Confirm Password
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div className="flex items-start">
                <input
                  ...
                  name="terms"
                  type="checkbox"
                  className="h-5 w-5 text-[#e54616] focus:ring-[#e54616] border-[#f8a27a] rounded mt-1"
                />
                <label htmlFor="terms" className="ml-2 block text-sm text-[#4a1f0f]">
                  I agree to the{' '}
                  <a href="/terms" className="text-[#e54616] hover:text-[#ff7043]">
                    Terms of Service
                  </a>{' '}
                  and{' '}
                  <a href="/privacy" className="text-[#e54616] hover:text-[#ff7043]">
                    Privacy Policy
                  </a>
                </label>
              </div>
